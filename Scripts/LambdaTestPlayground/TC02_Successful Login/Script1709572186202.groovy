...
WebUI.setText(findTestObject('Object Repository/Ecommerce/Page_Account Login/input_E-Mail Address_email'), 'jorisamadhan@gmail.com')

WebUI.setEncryptedText(findTestObject('Object Repository/Ecommerce/Page_Account Login/input_Password_password'), 's+D4/nQBI/t4t4P+r+MeoA==')

WebUI.click(findTestObject('Object Repository/Ecommerce/Page_Account Login/input_Forgotten Password_btn btn-primary'))

WebUI.verifyElementPresent(findTestObject('Ecommerce/Page_My Account/h2_My Account'), 5)
